...
public class SO {
    ...
    public void setData(Map<String,Object> classObj){
        ...
        M2OField partner_id = OdooUtility.getMany2One(classObj,
                "partner_id");
        ...
        setClientOrderRef(OdooUtility.getString(classObj,
                "client_order_ref"));
        setState(OdooUtility.getString(classObj, "user_id"));
        M2OField warehouse_id = OdooUtility.getMany2One(classObj,
                "medium_id");
